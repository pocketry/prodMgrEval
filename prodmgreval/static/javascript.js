...
function updateEval(e) {
    ...
    for (category in evaluation) {
        console.log(evaluation[category]);
        // console.log();
        if (evaluation[category]["name"] == e.parentElement.parentElement.id) {
            for (criterion in evaluation[category]["criteria"]) {
                console.log(criterion);
                if (criterion["name"] == e.id) {
